...
#define TEXTURE "wood"    //  wood c stones stones2 stones3 bricks2
...
void WidgetOpenGL::initializeGL()
{
    ...
    try
    {
        ...
        Model model;
        model.readFile("../../models-obj/" MODEL ".obj", true, true, true, 0.8);
        ...
        Model model_light;
        model_light.readFile("../../models-obj/sphere.obj", true, true, true, 0.4);
